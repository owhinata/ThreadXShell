...
#include "fs_devices.h"       /* declares the fs_qspi_device() defined below */
#include "fs_glue.h"
...
CLI_SUBCMD_SET_CREATE(fs_subcmds,
	CLI_CMD_ARG_USAGE(format, NULL, "format [full] -- confirm with 'yes'",
	                  "[full] yes",           cmd_fs_format, 1, 2),
