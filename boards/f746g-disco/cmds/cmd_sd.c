...
#include "fs_devices.h"       /* declares the fs_sd_device() defined below */
...
CLI_SUBCMD_SET_CREATE(sd_subcmds,
	...
	CLI_CMD_ARG_USAGE(read,   NULL, "hexdump one 512 B block <lba>",
	                  "<lba>",         cmd_sd_read,   2, 0),
	CLI_CMD_ARG_USAGE(format, NULL, "format as FAT32 -- confirm with 'yes'",
	                  "[exfat] yes",   cmd_sd_format, 1, 2),
	CLI_CMD_ARG_USAGE(ls,     NULL, "list directory [path]",
	                  "[path]",        cmd_sd_ls,     1, 1),
	CLI_CMD_ARG_USAGE(cat,    NULL, "print file <path>",
	                  "<path>",        cmd_sd_cat,    2, 0),
	CLI_CMD_ARG_USAGE(write,  NULL, "write <path> <text>",
	                  "<path> <text>", cmd_sd_write,  3, 0),
	CLI_CMD_ARG_USAGE(rm,     NULL, "delete file/empty dir <path>",
	                  "<path>",        cmd_sd_rm,     2, 0),
	CLI_CMD_ARG_USAGE(mkdir,  NULL, "create directory <path>",
	                  "<path>",        cmd_sd_mkdir,  2, 0),
