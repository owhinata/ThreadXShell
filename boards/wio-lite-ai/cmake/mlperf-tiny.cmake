...
add_library(mlperf_obj OBJECT
    ...
    "${BOARD_DIR}/port/mlperf/mlperf_th.cc")
...
target_include_directories(mlperf_obj PRIVATE
    ...
    "${BOARD_DIR}/port/mlperf"
    "${BOARD_DIR}/port/nn"        # nn.h: the model this harness runs
    "${BOARD_DIR}/port/threadx"   # tx_glue.h: the microsecond clock
...
set_source_files_properties("${MLPERF_API}/internally_implemented.cpp" PROPERTIES
    COMPILE_OPTIONS "-include;${BOARD_DIR}/port/mlperf/mlperf_th.h")
