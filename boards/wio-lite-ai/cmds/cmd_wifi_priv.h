 ...
 * @brief   Private seams of the `wifi` command family (owhinata/wio-lite-ai#28).
 *
 * The `wifi` root command spans three translation units -- cmd_wifi.c (power / L2 /
 * eRPC), cmd_wifi_flash.c (owhinata/wio-lite-ai#19 download-mode flashing) and
 * cmd_wifi_link.c (owhinata/wio-lite-ai#23 link diagnostics, the `wifi link` subtree)
 * -- but registers ONE table in cmd_wifi.c.  This header is the seam between them and
 ...
 *   cmd_wifi_flash.c: `wifi flash <sub>`, the owhinata/wio-lite-ai#19 download-mode
 * flasher cmd_wifi_link.c:  `wifi link <sub>`,  the owhinata/wio-lite-ai#23 link
 * diagnostics
 */
