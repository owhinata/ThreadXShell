...
/**
 * @file    nn_tflm_priv.h
 * @brief   Interfaces shared between the three files of the tflm backend
 ...
 *
 * Both numbers doubled in owhinata/wio-lite-ai#55, and they had to move together: MLPerf
 * Tiny's IC02 is a 512,024 B flatbuffer, which is what set the blob slot size, and a
 * staging buffer smaller than a blob slot would reintroduce exactly the "refused for an
 ...
 *     nn_tflm_model_buf  2x512 KB   (owhinata/wio-lite-ai#55: was 2x256 KB)
