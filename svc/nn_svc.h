...
#include "nn_detail.h"       /* NN_SVC_DETAIL_MAX, NN_SVC_DETAIL_LIT (#122) */
...
/* NN_SVC_DETAIL_MAX and the build-time length check on a board's wording
 * (NN_SVC_DETAIL_LIT / _CHECK_FMT) are in nn_detail.h, which a board's own
 * text tables include without pulling in this contract. */
